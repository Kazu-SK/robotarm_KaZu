...
void TestOperation::TestOperationInitialize(){
	...
	robot_joint[SERVO_ID_0].value_speed = 20;
	...
	robot_joint[SERVO_ID_1].value_speed = 20;
	...
	robot_joint[SERVO_ID_2].value_speed = 20;
	robot_joint[SERVO_ID_2].position = 90.0;
	robot_joint[SERVO_ID_2].position = 0.0;
	robot_joint[SERVO_ID_2].offset = 6.0;

	robot_joint[SERVO_ID_3].channel_num = 3;
	robot_joint[SERVO_ID_3].value_speed = 20;
	...
	robot_joint[SERVO_ID_4].value_speed = 20;
	...
	robot_joint[SERVO_ID_5].value_speed = 20;
